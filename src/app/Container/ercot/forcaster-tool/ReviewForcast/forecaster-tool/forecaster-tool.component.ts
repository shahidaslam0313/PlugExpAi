...
import { MatDialog, MatDatepicker, MAT_DATE_LOCALE, DateAdapter, MAT_DATE_FORMATS, MatTableDataSource } from '@angular/material';
...
import { DialogHourlyComponent } from '../dialog-hourly/dialog-hourly.component';
...
@Component({
  selector: 'app-forecaster-tool',
  templateUrl: './forecaster-tool.component.html',
  styleUrls: ['./forecaster-tool.component.scss', '../../../../button.scss'],
  animations: [
    trigger('slideInOut', [
      transition(':enter', [
...
export class ForecasterToolComponent implements OnInit {
