...
@Component({
  selector: 'app-dialog-forcaster-weather-zone',
  templateUrl: './dialog-forcaster-weather-zone.component.html',
  styleUrls: ['./dialog-forcaster-weather-zone.component.scss', '../../../../table.scss']
})
export class DialogForcasterWeatherZoneComponent implements OnInit {
