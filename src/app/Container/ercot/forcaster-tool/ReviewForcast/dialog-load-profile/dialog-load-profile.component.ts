...
@Component({
  selector: 'app-dialog-load-profile',
  templateUrl: './dialog-load-profile.component.html',
  styleUrls: ['./dialog-load-profile.component.scss', '../../../../table.scss']
})
export class DialogLoadProfileComponent implements OnInit {
