...
@Component({
  selector: 'app-dialog-weatherzone-profile',
  templateUrl: './dialog-weatherzone-profile.component.html',
  styleUrls: ['./dialog-weatherzone-profile.component.scss', '../../../../table.scss']
})
export class DialogWeatherzoneProfileComponent implements OnInit {
