...
@Component({
  selector: 'app-dialog-count-load',
  templateUrl: './dialog-count-load.component.html',
  styleUrls: ['./dialog-count-load.component.scss', '../../../../table.scss']
})
export class DialogCountLoadComponent implements OnInit {
