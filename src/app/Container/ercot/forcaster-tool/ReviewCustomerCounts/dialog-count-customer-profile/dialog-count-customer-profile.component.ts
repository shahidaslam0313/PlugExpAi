...
@Component({
  selector: 'app-dialog-count-customer-profile',
  templateUrl: './dialog-count-customer-profile.component.html',
  styleUrls: ['./dialog-count-customer-profile.component.scss', '../../../../table.scss']
})
export class DialogCountCustomerProfileComponent implements OnInit {
