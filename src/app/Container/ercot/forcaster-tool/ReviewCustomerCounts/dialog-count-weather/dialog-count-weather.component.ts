...
@Component({
  selector: 'app-dialog-count-weather',
  templateUrl: './dialog-count-weather.component.html',
  styleUrls: ['./dialog-count-weather.component.scss', '../../../../table.scss']
})
export class DialogCountWeatherComponent implements OnInit {
