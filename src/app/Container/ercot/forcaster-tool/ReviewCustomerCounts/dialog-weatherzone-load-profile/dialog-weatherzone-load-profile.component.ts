...
@Component({
  selector: 'app-dialog-weatherzone-load-profile',
  templateUrl: './dialog-weatherzone-load-profile.component.html',
  styleUrls: ['./dialog-weatherzone-load-profile.component.scss', '../../../../table.scss']
})
export class DialogWeatherzoneLoadProfileComponent implements OnInit {
