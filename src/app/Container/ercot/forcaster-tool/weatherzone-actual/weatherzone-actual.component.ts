...
@Component({
  selector: 'app-weatherzone-actual',
  templateUrl: './weatherzone-actual.component.html',
  styleUrls: ['./weatherzone-actual.component.scss', '../../../table.scss','../../../button.scss']
})
export class WeatherzoneActualComponent implements OnInit {
  ...
  getZoneActual(i, date) {
    ...
    this.service.weatherZoneActual(this.obj).subscribe(res => {
      console.log(res)
      console.log(i)
      if (i === 0) {
        this.day1 = true
